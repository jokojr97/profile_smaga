...
<div class="row">
  <div class="container">
    <div class="col-lg-6 col-lg-offset-3">
      ...
      <div class="simple-page-form animated flipInY marginlogin" id="login-form">
        <center>
          <a href="<?= base_url() ?>"><img src="<?= base_url() ?>/assets/home/img/logo.PNG" class="img img-responsive"></a>
          <h3>LOGIN</h3><br>
        </center>
        <?= $this->session->flashdata('message'); ?>
        <form action="<?= base_url('auth/index') ?>" method="post">
          <div class="form-group">
            <input id="username" type="text" name="username" class="form-control" placeholder="username" value="<?= set_value('username') ?>" autofocus>
