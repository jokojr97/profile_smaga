    ...
    <section id="speakers-details" class="wow fadeIn" style="margin-top: -60px">
      <div class="container-fluid" style="padding:30px">
        <div class="container">
          <div class="row">
            <div class="col-7">
              <h4 class=" text-orange pt-1 header11" style="text-transform: uppercase;">PETA DATA DESA <?= $kabupaten ?></h4>
            </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="border p-3">                
              ...
              if ($kabupaten == "bojonegoro") {
              ?>
              <p><iframe style="width: 100%; height: 520px; border: 0px;" src="https://bi.or.id/desa/" width="300" height="150"></iframe></p>
              <?php   
              }else {
              ?>
              <p><iframe style="width: 100%; height: 520px; border: 0px;" src="https://bi.or.id/peta-tuban/" width="300" height="150"></iframe></p>
              <?php   
              }
              ?>   
            </div>         
...
<script type="text/javascript">
  ...
  function kabfunction(id){
    var idss = id.value;
   window.location.replace("<?= base_url() ?>peta_desa"+idss+""); 
  }
</script>