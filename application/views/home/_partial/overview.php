                    ...
                    <div class="row" class="mt-3">
                      ...
                      ?>
                          <div class="col-md-3 col-6">
                            ...
                            <b><a href="<?= base_url() ?>home/berita_view/<?= $row->id_post ?>">
                                <p style="line-height: 1.2"><?= $row->judul ?></p>
                              </a></b>
    ...
    <section id="ttgAplikasi" class="wow fadeInUp mt-3 mb-3 p-3 bg-light">
      <div class="container mt-3">
        ...
        <div class="row">
          <div class="row">
           <div class="col-md-7">
             <p style="font-size: 18px">SMAN 3 Bojonegoro atau PRCI adalah sebuah organiasi masyarakat sipil atau Civil Society Organization (CSO) yang bergerak di bidang penelitian, advokasi yang berfokus pada sektor kemiskinan, gender dan pertanian di Kabupaten Bojonegoro, Provinsi Jawa Timur, dan Nasional</p>
