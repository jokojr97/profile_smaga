    ...
    <section id="speakers-details" class="wow fadeIn" style="margin-top: -60px">
      <div class="container-fluid" style="padding:30px">
        <div class="container">
          <div class="row">
            <div class="col-7">
              <h4 class="text-orange pt-1 header11" style="text-transform: uppercase;">PETA DATA KECAMATAN <?= $kabupaten ?></h4>
            </div>
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="p-3 border">
              <embed src="https://bi.or.id/kecamatan/index.html" style="width: 100%; height: 520px; border: 0px;"></embed>              
            </div>
