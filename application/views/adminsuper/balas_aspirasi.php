...
<div class="container-fluid">
		...
		<a href="<?= base_url('adminsuper/aspirasi_publik') ?>"><i class="fas fa-arrow-left"></i> Kembali ke Halaman Aspirasi Publik</a><br>
	<div class="row p-3">
		<div class="col-md-8">	
				...
				<div class="bg-white p-3 border">					
	            	<h6><strong>Balas</strong></h6>
		                <form  action="<?= base_url() ?>adminsuper/balas_aspirasi" method="post" enctype="multipart/form-data">
