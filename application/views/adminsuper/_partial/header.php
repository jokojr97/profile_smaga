...
<head>
  ...
  <title>Sistem Informasi Satu Data - Tlogorejo</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="<?= base_url() ?>" class="brand-link  bg-dark">
      <img src="<?= base_url() ?>assets/iconhead.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="<?= base_url() ?>adminsuper" class="nav-link <?php  if($this->session->flashdata('menu') == "dashboard"){echo "active";} ?>">
          ...
          <li class="nav-item">
            <a href="<?= base_url('adminsuper/data_desa') ?>" class="nav-link <?php  if($this->session->flashdata('menu') == "datadesa"){echo "active";} ?>">
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url('adminsuper/pengguna') ?>" class="nav-link <?php  if($this->session->flashdata('menu') == "pengguna"){echo "active";} ?>">
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url('adminsuper/aspirasi_publik') ?>" class="nav-link <?php if($this->session->flashdata('menu') == "aspirasi"){echo "active";} ?>">
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url('adminsuper/profil') ?>" class="nav-link <?php if($this->session->flashdata('menu') == "profil"){echo "active";} ?>">
          ...
          <li class="nav-item has-treeview">
            <a href="<?= base_url('adminsuper/change_password') ?>" class="nav-link <?php if($this->session->flashdata('menu') == "password"){echo "active";} ?>">
