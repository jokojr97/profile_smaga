...
<div class="container-fluid">
    ...
    <!-- form -->
    <form action="<?= base_url() ?>admins/facilities/edit" method="post" enctype="multipart/form-data">
        <!-- row -->
        <div class="row">
            <!-- col -->
            <div class="col-md-7">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="judul" class="form-control" placeholder="Masukkan Judul Post ..." value="<?= $facilities['name'] ?>">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="tanggal" class="form-control" value="<?= $facilities['date_created'] ?>">
                </div>
                <!-- // form-group -->
