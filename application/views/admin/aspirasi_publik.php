				...
				<div class="card card-body border">				
					<div class="media">
					  ...
					  <div class="media-body">
		                ...
		                <a href="<?= base_url() ?>admin/balas_aspirasi/<?= $proses->id ?>" class="btn btn-danger border"><span class="fa fa-comment "></span>&nbsp;&nbsp;Balas</a>
					  </div>
					</div>
				</div>
				<?php $i++; } ?>
				...
				<div class="card card-body border">				
					<div class="media">
					  ...
					  <div class="media-body">
		                ...
		                <a href="<?= base_url() ?>admin/balas_aspirasi/<?= $selesai->id ?>" class="btn btn-danger border"><span class="fa fa-comment "></span>&nbsp;&nbsp;Balas</a>
					  </div>
					</div>
				</div>
				<?php $j++; } ?>
...
<?php $this->load->view('admin/_partial/highchart',$data) ?>