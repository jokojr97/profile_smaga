...
<div class="container-fluid">
    ...
    <!-- form -->
    <form action="<?= base_url() ?>admins/galeri/editfoto" method="post" enctype="multipart/form-data">
        <!-- row -->
        <div class="row">
            <!-- col -->
            <div class="col-md-7">
            ...
            <div class="col-md-5">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="judul" class="form-control" placeholder="Masukkan Judul Post ..." value="<?= $foto['title'] ?>">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="tanggal" class="form-control" value="<?= $foto['upload_date']; ?>">
                </div>
                <!-- // form-group -->
